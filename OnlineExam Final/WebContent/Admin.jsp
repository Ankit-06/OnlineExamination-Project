 	...
 	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="reportCard.jsp" method="post">
					...
					<div class="wrap-input100 validate-input m-b-26" data-validate="Email ID is required">
						...
						<input class="input100" type="email" name="EmailId" placeholder="Enter student Email ID">
