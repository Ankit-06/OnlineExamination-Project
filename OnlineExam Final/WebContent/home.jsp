                    ...
                    <div class="container">
                        ...
                        <div id="main-nav" class="stellarnav">
                        	<ul id="nav" class="nav navbar-nav pull-left">
                                <li class="active"><a href="#home" target="_parent" style="font-weight: bold;font-style: oblique;font-family:'Sofia'; font-size: 30px;"><img src="assest/img/favicon.ico"></a></li>
                            </ul>
                            <ul id="nav" class="nav navbar-nav pull-right">
                                <li class="active"><a href="#home" target="_parent">Home</a></li>                                
                ...
                <div class="welcome-area">
                    <div class="container">
                        <div class="row flex-v-center">
                            <div class="col-md-8 col-lg-7 col-sm-12 col-xs-12">
                                <div class="welcome-text">
                                    <h1>There's more to life than just passing exams.</h1>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row course-list">
                ...
                <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                    <div class="single-course mb20">
                        <img src="assest/img/course/bca.jpg" alt="BCA">
                        <div class="course-details padding30">
                            <h3 class="font18">BCA</h3>
                            <p>Bachelor of Computer Application</p>
                            <p class="mt30"><a href="Bca-Sem.jsp" class="enroll-button">Select Sem</a></p>
                        </div>
                    </div>
                </div>
                	<!-- Second Course -->
                <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                    <div class="single-course mb20">
                        <img src="assest/img/course/bcom.jpg" alt="B.com">
                        <div class="course-details padding30">
                ...
                <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                    <div class="single-course mb20">
                        <img src="assest/img/course/bba.jpg" alt="BBA">
                        <div class="course-details padding30">
                ...
                <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                    <div class="single-course mb20">
                        <img src="assest/img/course/btech.png" alt="Btech">
                        <div class="course-details padding30">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                    <div class="single-blog-item sm-mb30 xs-mb30 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="blog-thumb">
                           <a href="https://bit.ly/2TaSnMt"><img src="assest/img/blog/blog-1.jpg"></a>
                        </div>
                        <div class="blog-details padding30">
                            <h3 class="blog-title font20 mb30"><a href="https://bit.ly/3xeHckr">What is the Best Time to Study? Day vs Night</a></h3>
                            <p class="blog-meta font14 mt20">August 6, 2017 by Diego Santos </p>
                        </div>
                    </div>
                </div>
                	<!-- Second blog -->
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                    <div class="single-blog-item sm-mb30 xs-mb30 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="blog-thumb">
                            <a href="https://bit.ly/3zgN7aI"><img src="assest/img/blog/blog-2.jpg"></a>
                        </div>
                        <div class="blog-details padding30">
                            <h3 class="blog-title font20 mb30"><a href="https://bit.ly/3zgN7aI">Organise your Subjects for Study Success</a></h3>
                            <p class="blog-meta font14 mt20">August 19, 2014 by Maya Velasquez</p>
                        </div>
                    </div>
                </div>
                	<!-- Third blog -->
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                    <div class="single-blog-item sm-mb30 xs-mb30 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="blog-thumb">
                            <a href="https://bit.ly/3zgF2mw"><img src="assest/img/blog/blog-3.jpg" alt=""></a>
                        </div>
                        <div class="blog-details padding30">
                            <h3 class="blog-title font20 mb30"><a href="https://bit.ly/3zgF2mw">How to Beat Exam Stress in 10 Easy Ways</a></h3>
                            <p class="blog-meta font14 mt20">April 22, 2017  by Andrea Leyden</p>
                        </div>
                    </div>
                </div>
            </div>
