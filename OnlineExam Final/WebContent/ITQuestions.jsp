                    ...
                    <div class="container">
                        ...
                        <div id="main-nav" class="stellarnav" style="background-color:black;">
                            ...
                            <ul id="nav" class="nav navbar-nav pull-right">
                                ...
                                <br><li style = "font-color : white; font-size:30px;align:center;right:40%;top:17%"> Fundamentals of Information Technology</li>
...
<br><br>
<h4>1)The memory sizes in mainframe computers and advanced technology micro computer are expressed as</h4>
...
<h4>2)Who invented the super computer?</h4>
<label class="radio-inline">
...
<h4>3)Which of the following items is not used in LAN?</h4>
<label class="radio-inline">
...
<h4>4)Popular network operating systems include all of the following except</h4>
...
<h4>5)_________ is the lower part of TCP/IP whose function is to handle the address part of each packet to enable it to be delivered to the right destination.</h4>
<label class="radio-inline">
...
<h4>6)  Which of the following accesss modifier specifies that one or more declared programming elements are accessible from within the assembly that contains their declaration, not only by the component that declares them?</h4>
<label class="radio-inline">
...
<h4>7)A ___________ performs invisible tasks even if you write no code</h4>
<label class="radio-inline">
...
<h4>8)Which of the following is not correct about the value types and reference types in VB.NET?</h4>
<label class="radio-inline">
...
<h4>9)The _________________ enable us to pass data between a program and a class.</h4>
<label class="radio-inline">
...
<h4>10)Which is true about the name and text property of a control?</h4>
<label class="radio-inline">
...
<%	
	String it="it";
	session.setAttribute("subject",it);			//setting attribute with the subject name.
%>
